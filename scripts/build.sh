...
rm -r ../../node_modules/@polkadot/x-fetch
...
rm -r ../../node_modules/@polkadot/x-ws
...
cp -r packages/x-fetch/build ../../node_modules/@polkadot/x-fetch
...
cp -r packages/x-ws/build ../../node_modules/@polkadot/x-ws
